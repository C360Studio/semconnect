...
dev_handoff_sha=$($sha -a 256 openspec/changes/qualify-semstreams-beta149/evidence/development/go/go-developer-handoff.json | /usr/bin/awk '{print $1}')
...
$jq -n -S \
  ...
  '{
    ...
    upstreamVendors: {semstreams: $semstreamsVendorHead, ets: $etsVendorHead},
    expectedSemstreams: {
      version: "v1.0.0-beta.149",
      commit: "7db0cdcb21577eaa52eb842c4ffb06a854f9a9b2"
    },
    preBuildAttestation: {
      path: "openspec/changes/qualify-semstreams-beta149/evidence/development/go/go-developer-handoff.json",
      sha256: $devHandoffSha,
      signedAt: "2026-07-18T10:39:30Z",
      evidenceBundleSha256: "b12f6f9daa8e8d81397b832f252df430bde5354cc17a78048a14c378096030fd"
    },
    sourceHashes: {
      "go.mod": $goModSha,
      "go.sum": $goSumSha,
