...
func TestNegotiate(t *testing.T) {
	...
	tests := []struct {
		...
		{"SensorML spec form wired on deployment item", "application/sml+json", FamilyDeploymentItem, MediaSensorML, true},
		{"SensorML spec form wired on property item", "application/sml+json", FamilyPropertyItem, MediaSensorML, true},
...
func TestNegotiateRequest_FParameterOverridesAccept(t *testing.T) {
	...
	tests := []struct {
		...
		{"f=sensorml on deployment item",
			"/deployments/x?f=sensorml", "", FamilyDeploymentItem, MediaSensorML, true},
		{"f=sensorml on property item",
			"/properties/x?f=sensorml", "", FamilyPropertyItem, MediaSensorML, true},
